...
graph TD
    ...
    subgraph CV["CV / YOLO Image Datasets"]
        D24["combined-vegetables-fruits<br/>Roboflow: yolo-jpkho<br/>Raw fruit and vegetable bounding box dataset"]
        D25["food-ingredients-dataset<br/>Roboflow: food-recipe-ingredient-images-0gnku<br/>Diverse recipe ingredient image dataset"]
        D26["indianfoodnet<br/>Roboflow: indianfoodnet<br/>Targeted Indian dish image dataset"]
        D27["dataset/pending/<br/>Local Pending Directory<br/>Images flagged for HitL review"]
        D28["dataset/trained/<br/>Local Trained Directory<br/>HitL annotated images for custom fine-tuning"]
    end
```
